export default function Policy () {
  return (
    <div className="pt-10">
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 pb-5">
        <h1 className="text-5xl py-5">Privacy Policy</h1>
        <p>
          Growth Creative AI built the GrowthCreative.ai app as a Commercial
          app. This SERVICE is provided by Growth Creative AI and is intended
          ...
          growthcreative.ai unless otherwise defined in this Privacy Policy.
        </p>
        <h3 className="text-3xl py-5">Information Collection and Use</h3>
        <p>
          For a better experience, while using our Service, we may require you
          to provide us with certain personally identifiable information,
          including but not limited to email, name. The information that we
          ...
          party service providers used by the app Google Services
        </p>
        <h3 className="text-3xl py-5">Log Data</h3>
        <p>
        ...
        <h3 className="text-3xl py-5">Cookies</h3>
        <p>
        ...
        <h3 className="text-3xl py-5">Service Providers</h3>
        <p>
        ...
        <h3 className="text-3xl py-5">Security</h3>
        <p>
        ...
        <h3 className="text-3xl py-5">Links to Other Sites</h3>
        <p>
        ...
        <h3 className="text-3xl py-5">Children&apos;s Privacy</h3>
        <p>
        ...
        <h3 className="text-3xl py-5">Changes to This Privacy Policy</h3>
        <p>
          We may update our Privacy Policy from time to time. Thus, you are
          advised to review this page periodically for any changes. We will
          notify you of any changes by posting the new Privacy Policy on this
          page. This policy is effective as of 2021-07-11
        </p>
        <h3 className="text-3xl py-5">Contact Us</h3>
        <p>
          If you have any questions or suggestions about our Privacy Policy, do
          not hesitate to contact us at support@growthcreative.ai.
        </p>
      </div>
    </div>
  );
